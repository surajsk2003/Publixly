...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 backdrop-blur-xl border-b ${
        isScrolled 
          ? 'bg-white/95 dark:bg-gray-900/95 shadow-2xl shadow-gray-900/10 border-gray-200/20 dark:border-gray-700/20' 
          : 'bg-white/80 dark:bg-gray-900/80 border-gray-200/10 dark:border-gray-700/10'
      }`}>
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="px-4 py-6 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-200/20 dark:border-gray-700/20">
            <nav className="space-y-4" role="navigation" aria-label="Mobile navigation">
              <Link 
                href="/articles" 
                className="flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-all duration-200"
              ...
              <Link 
                href="/newsletter" 
                className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
